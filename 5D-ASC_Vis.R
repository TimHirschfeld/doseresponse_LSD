...
data <- read_excel("5D-ASC_Vis.xlsx", col_names = TRUE, col_types = "guess", na = "NULL")

##############################################################################
# Individuelle Regressionsanalyse  #

#defining variables as numeric
Scale_std <- as.numeric(data$Visionary_Restructuralization_std)        # standard deviation
effect_sizes <- as.numeric(data$Visionary_Restructuralization_mean)    # mean
...
tiff(filename = "5D-ASC_Vis.tiff", units="cm", width=14.55, height=11.684, res=600)
