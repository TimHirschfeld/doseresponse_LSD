...
data <- read_excel("11-ASC_Exp.xlsx", col_names = TRUE, col_types = "guess", na = "NULL")

##############################################################################
# Individuelle Regressionsanalyse  #

#defining variables as numeric
Scale_std <- as.numeric(data$Experience_of_unity_std)        # standard deviation
effect_sizes <- as.numeric(data$Experience_of_unity_mean)    # mean
...
tiff(filename = "11-ASC_Exp.tiff", units="cm", width=14.55, height=11.684, res=600)
