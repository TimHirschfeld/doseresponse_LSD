...
data <- read_excel("5D-ASC_OB.xlsx", col_names = TRUE, col_types = "guess", na = "NULL")

########################################################################
# Individuelle Regressionsanalyse  #

#defining variables as numeric
Scale_std <- as.numeric(data$Oceanic_Boundlessness_std)        # standard deviation
effect_sizes <- as.numeric(data$Oceanic_Boundlessness_mean)    # mean
...
tiff(filename = "5D-ASC_OB.tiff", units="cm", width=14.55, height=11.684, res=600)
