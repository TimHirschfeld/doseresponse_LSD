...
data <- read_excel("5D-ASC_DED.xlsx", col_names = TRUE, col_types = "guess", na = "NULL")

############################################################################
# Individuelle Regressionsanalyse  #

#defining variables as numeric
Scale_std <- as.numeric(data$Dread_of_Ego_Dissolution_std)        # standard deviation
effect_sizes <- as.numeric(data$Dread_of_Ego_Dissolution_mean)    # mean
...
tiff(filename = "5D-ASC_DED.tiff", units="cm", width=14.55, height=11.684, res=600)
