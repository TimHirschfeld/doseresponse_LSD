...
data <- read_excel("MEQ30_Tran.xlsx", col_names = TRUE, col_types = "guess", na = "NULL")

##############################################################################
# Individuelle Regressionsanalyse  #

#defining variables as numeric
Scale_std <- as.numeric(data$Transcendence_of_time_and_space_std)     # standard deviation
effect_sizes <- as.numeric(data$Transcendence_of_time_and_space_mean) # mean
...
tiff(filename = "MEQ30_Tran.tiff", units="cm", width=14.55, height=11.684, res=600)
